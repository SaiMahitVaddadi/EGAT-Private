## TO-DO:
- Training Loop:
    - log multiple loss functions in the training loss.
    - save things epoch by epoch    
    - save each epoch result in one big csv file
    - Write in cross-validation data in one save folder 
...
- Models:
    ...
    - Create a Fingerprint only model
