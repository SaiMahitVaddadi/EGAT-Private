...
class ReactionFeaturizerwithGeometry(ReactiveAtomInformation,ReactiveBondInformation,ReactiveAtomChangeInformation):
...
from ..base.component import BaseReactionComponentFeaturizer
from ..base.information import ReactiveAtomInformation,ReactiveBondInformation,ReactiveAtomChangeInformation,GlobalReactionBondInformation
from ..molecular.MoleculeGlobal import MoleculeFeaturizerwithPadding
from ..base.reaction import BaseReactionFeaturizer
from .helper import ReactionHelper
...
class ReactionFeaturizerwithPadding(ReactionFeaturizer,ReactionHelper,ReactiveAtomInformation,ReactiveBondInformation,ReactiveAtomChangeInformation,GlobalReactionBondInformation):
    def __init__(self,reaction_smiles,arguments,denotation='>>'):
