...
from ..molecular.MoleculeGeometry import MoleculeFeaturizerwithGeometry
from ..base.reaction import BaseReactionFeaturizer
from .helper import ReactionHelper
from .Reaction import ReactionFeaturizer
class ReactionComponentFeaturizer(BaseReactionComponentFeaturizer,MoleculeFeaturizerwithGeometry):
    def __init__(self, smiles, arguments):
        super(BaseReactionComponentFeaturizer, self).__init__(smiles, arguments)
        super(MoleculeFeaturizerwithGeometry, self).__init__(smiles, arguments)
    

class ReactionFeaturizerwithGeometry(BaseReactionFeaturizer,ReactionFeaturizer,ReactionHelper,ReactiveAtomInformation,ReactiveBondInformation,ReactiveAtomChangeInformation,ReactiveBondGeometryInformation,ReactiveAtomGeometryInformation):
