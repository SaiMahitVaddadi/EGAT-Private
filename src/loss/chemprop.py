...
class MCCClassLoss(nn.Module):
    def __init__(self):
        super(MCCClassLoss, self).__init__()

    def forward(self, predictions, targets, data_weights=1,mask=1):
...
class MCCMultiClassLoss(nn.Module):
    def __init__(self):
        super(MCCMultiClassLoss, self).__init__()
...
class DirchletMultiClassLoss(nn.Module):
    def __init__(self):
        super(DirchletMultiClassLoss, self).__init__()

    def forward(self, alphas, target_labels, lam=0):
        """
